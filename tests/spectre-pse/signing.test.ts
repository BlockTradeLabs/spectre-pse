...
import { SpectrePse } from "@/typings/SpectrePse";

describe("SpectrePse test", () => {
    let factory: SpectrePse.Factory;
    let contract: SpectrePse.Contract;
    let signer: KeyringPair;
    let certificate : PhalaSdk.CertificateData;

    before(async function() {
        factory = await this.devPhase.getFactory(
            './contracts/spectre-pse/target/ink/spectre-pse.contract',
